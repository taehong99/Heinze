...
//{
//    public List<PlayerSkillDataSO> deck = new List<PlayerSkillDataSO>();  // 카드 덱
...
//    public List<PlayerSkillDataSO> result = new List<PlayerSkillDataSO>();  // 랜덤하게 선택된 카드를 담을 리스트
...
//    public PlayerSkillDataSO RandomCard()
//    {
//        return null;
//    }
